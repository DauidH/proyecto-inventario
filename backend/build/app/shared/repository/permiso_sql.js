...
exports.SQL_PERMISO = void 0;
exports.SQL_PERMISO = {
    CREAR_PERMISO: "INSERT INTO  funcionalidad_usuario (cod_funcionalidad,cod_usuario) \
  VALUES (1,$1)",
    CONSULTAR: "SELECT f.cod_funcionalidad, f.cod_padre, f.orden_funcionalidad, f.nombre_funcionalidad, \
  ...
  ORDER BY f.orden_funcionalidad, f.cod_funcionalidad, f.cod_padre",
    FUNCIONALIDAD_USUARIO: "SELECT cod_usuario \
