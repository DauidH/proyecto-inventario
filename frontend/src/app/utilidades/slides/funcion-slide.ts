export class funcionSlide {

  public static slideUp(elm: any, duration = 300): void {
  ...
  public static slideDown(elm: any, duration = 300): void {
    if (!elm.classList.contains('transitioning')) {
      elm.classList.add('transitioning');
  ...
  public static slideToggle(elm: any, duration = 300) {
    if (window.getComputedStyle(elm).display === 'none') {
      this.slideDown(elm, duration);
    } else {
      this.slideUp(elm, duration);
    }
  }
