import {
  ...
  import { funcionSlide } from './../../../../utilidades/slides/funcion-slide';
  ...
  export class SidebarComponent implements AfterViewChecked {
	...
	toggleNavProfile(e: any) {
	  ...
	  if (targetProfile && targetProfile.style) {
		...
		funcionSlide.slideToggle(targetProfile, expandTime);
		  ...
		  menu.onclick = function (e: any) {
			...
			menus.map(function (m: any) {
			  ...
			  if (otherTarget !== target) {
				funcionSlide.slideUp(otherTarget, expandTime);
				otherTarget.closest('.menu-item').classList.remove('expand');
				otherTarget.closest('.menu-item').classList.add('closed');
			  }
			});
  
			var targetItemElm: any = target.closest('.menu-item');
			...
			if (
			  ...
			  funcionSlide.slideToggle(target, expandTime);
			} else {
	...
	public expandCollapseSubmenu(
	  ...
	  funcionSlide.slideToggle(target);
	}
	...
	constructor(
	  ...
	  this.sidebarScrollbar = this.tmp;
